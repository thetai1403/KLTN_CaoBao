...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="?module=news&action=admin_add" class="btn btn-primary shadow-sm rounded-pill px-4">
                            ...
                            <?php foreach($news as $article): ?>
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        ...
                                        <a href="?module=news&action=admin_edit&id=<?= $article['id'] ?? '' ?>" class="btn btn-sm btn-light text-primary rounded-circle me-1" style="width: 32px; height: 32px; padding: 0; line-height: 32px;" title="Sửa"><i class="fa-solid fa-pen"></i></a>
                                        
                                        <a href="?module=news&action=admin_list&delete_id=<?= $article['id'] ?? '' ?>" class="btn btn-sm btn-light text-danger rounded-circle" style="width: 32px; height: 32px; padding: 0; line-height: 32px;" title="Xoá" onclick="return confirm('Bạn có chắc muốn xoá bài báo này?');"><i class="fa-solid fa-trash-can"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
