...
<head>
    ...
    <style>
        ...
        .login-image h2 { font-weight: 700; margin-bottom: 0.5rem; }
        ...
        @media (max-width: 768px) {
            ...
            .login-card { max-width: 400px; margin: 0 1rem; }
        }
    </style>
</head>
<body>
    ...
    <div class="login-card">
        ...
        <div class="login-form-container">
            ...
            <div class="text-center mt-4">
                <a href="<?php echo _HOST_URL; ?>?module=home" class="text-muted small text-decoration-none"><i class="fa-solid fa-arrow-left me-1"></i> Trở về trang chủ</a>
            </div>
        </div>
    </div>
